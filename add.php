...
<div class = "col s9">
        <nav id = "options2" class="nav-extended">
    <div class="nav-wrapper">
      <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
      <ul id="nav-mobile" class="left hide-on-med-and-down">
                <li class = "active"><a>ADD QUIZ</a></li>
                <li><a href = "modify.php">TRACK PROGRESS</a></li>
                <li><a href="delete.php">REACH US</a></li>
      </ul>
    ...
    <div class="nav-content">
      <ul class="tabs tabs-transparent">
        <li class="tab"><a href = "#multiple">Multiple Choice</a></li>
        <li class="tab"><a class="active" href="#single">Single Answer</a></li>
      </ul>
    </div>
  </nav>

        <form id = "multiple" class="col s12 form1" action = "do_add.php" method = "POST">
        <br>
          <div class="row">
            ...
            <div class="input-field col s7 offset-s2">
              ...
              <textarea id="textarea1" class="materialize-textarea" name = "explanation" placeholder = 'optional'></textarea>
              <label for="textarea1"><span id = "format">Explanation</span></label>
            </div>
            <div>
        ...
        <form id = "single" class="col s12 form1" action = "do_add2.php" method = "POST">
        <br>
          <div class="row">
            <div class="input-field col s7 offset-s2">
              <i class="material-icons prefix">account_circle</i>
            ...
            <div class="input-field col s7 offset-s2">
                <i class="material-icons prefix">done</i>
                <input id="icon_prefix" type="text" class="validate" name = "copt" placeholder=" Not more than 3 space separated words" required>
                <label for="icon_prefix"><span id = "format">Answer*</span></label>
                <br><br>
            </div>
